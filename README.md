[![Netlify Status](https://api.netlify.com/api/v1/badges/9f2f756f-e1fc-48d9-9c07-b7d7433d8aaa/deploy-status)](https://app.netlify.com/sites/idyllic-cannoli-5d3cd8/deploys?filter=master)

# ☕ STARBUCKS

스타벅스 랜딩 페이지(홈페이지)를 만드는 예제입니다. <br>
강의를 통해서 코드를 이해하면서 진행한 개인 웹프로젝트입니다 <br>
